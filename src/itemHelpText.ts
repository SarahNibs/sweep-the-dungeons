...
**Cost**: 2 energy
**Effect**: 10 red pips will be distributed onto unrevealed tiles, either showing an area with by lots of your unrevealed tiles if such an area exists, or just showing you lots of tiles that probably aren't yours.
**Enhanced**: Refunds 1 energy unless it's the very first Instruction card played this floor.
**Curiosities**: It might show you two areas surrounded by lots of your unrevealed tiles, not just one, if 2+ such areas exist. If you see a tile with 5+ red pips, it's pretty likely you've been instructed to guess most everything adjacent to that tile. If it is a more even distribution, you might still have been instructed to guess most everything adjacent to a pipped tile, or the pips will have been distributed onto up to 10 random tiles weighted yours: 1, neutral: 2, rival's: 3, mined: 4, filtered to guarantee your tiles receive at most 1 pip. Maybe you can figure out which, with other context! Or you could just guess!
${snippets.instructions}
${snippets.bayes_instructions}
  `,
